  ...
  */
  ...
  function baseCreateRenderer(options, createHydrationFns) {
      ...
      const processText = (n1, n2, container, anchor) => {
          if (n1 == null) {
              hostInsert((n2.el = hostCreateText(n2.children, container)), container, anchor);
          }
          else {
      ...
      const processCommentNode = (n1, n2, container, anchor) => {
          if (n1 == null) {
              hostInsert((n2.el = hostCreateComment(n2.children || '', container)), container, anchor);
          }
          else {
      ...
      const mountElement = (vnode, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) => {
          ...
          {
              el = vnode.el = hostCreateElement(vnode.type, isSVG, props && props.is, props, container);
