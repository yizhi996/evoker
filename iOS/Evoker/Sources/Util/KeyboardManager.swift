...
extension KeyboardManager {
    ...
    public static let setValueSubscribeKey = SubscribeKey("WEBVIEW_KEYBOARD_SET_VALUE")
    
    public static let onShowSubscribeKey = SubscribeKey("WEBVIEW_KEYBOARD_ON_SHOW")
    
    public static let onHideSubscribeKey = SubscribeKey("WEBVIEW_KEYBOARD_ON_HIDE")
    
    public static let onConfirmSubscribeKey = SubscribeKey("WEBVIEW_KEYBOARD_ON_CONFIRM")
    
    public static let heightChangeSubscribeKey = SubscribeKey("KEYBOARD_HEIGHT_CHANGE")
}
