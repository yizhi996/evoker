...
class ActionSheet: UIView, TransitionView {
    ...
    init(params: Params) {
        ...
        cancelButton.setTitleColor(.evTextBlack, for: .normal)
...
extension ActionSheet: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: ActionSheetCell = tableView.dequeueReusableCell(for: indexPath)
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if hasAlertText {
            ...
            headerView.backgroundColor = .evWhite
...
class ActionSheetCell: UITableViewCell, ReuseableCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        titleLabel.textColor = .evTextBlack
