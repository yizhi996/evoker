...
class StaticTableViewCellInfo {
    ...
    var didSelectHandler: ((StaticTableViewCellInfo) -> Void)?
    
}

extension StaticTableViewCellInfo {
    ...
    @discardableResult
    func didSelect(_ handler: @escaping (StaticTableViewCellInfo) -> Void) -> Self {
