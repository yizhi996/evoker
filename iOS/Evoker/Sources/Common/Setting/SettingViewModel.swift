...
class SettingViewModel {
    ...
    init(appService: AppService) {
        ...
        sectionInfo = StaticTableViewSectionInfo(header: "允许“\(appService.appInfo.appName)”使用")
        ...
        var locationCellInfo: StaticTableViewCellInfo?
                ...
                if let locationCellInfo = locationCellInfo {
                    ...
                    let cellInfo = StaticTableViewCellInfo()
                        ...
                        .didSelect { [unowned self] cellInfo in
                            let viewModel = LocationSettingViewModel(current: locationKey)
    ...
    func locationAuthorizationValueChange(key: String, cellInfo: StaticTableViewCellInfo) {
        let viewController = appService.rootViewController!.viewControllers.last!
...
extension SettingViewModel {
    ...
    func generateViewController() -> UIViewController {
        return SettingViewController(viewModel: self)
    }
}
