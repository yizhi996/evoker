...
class AudioRecorder: NSObject {
    ...
    var onStartHandler: EmptyBlock?
    
    var onStopHandler: ((RecordData) -> Void)?
    
    var onPauseHandler: EmptyBlock?
    
    var onResumeHandler: EmptyBlock?
    
    var onInterruptionBeginHandler: EmptyBlock?
    
    var onInterruptionEndHandler: EmptyBlock?
