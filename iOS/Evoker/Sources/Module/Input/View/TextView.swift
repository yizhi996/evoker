...
open class TextView: UIView, TextInput {
        
    public var onFocus: EmptyBlock?
    
    public var onBlur: EmptyBlock?
    
    public var textChanged: StringBlock?
    
    public var onKeyboardReturn: EmptyBlock?
...
extension TextView: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        ...
        NotificationCenter.default.post(name: TextView.didChangeHeightNotification, object: self)
...
extension TextView {
    ...
    public static let heightChangeSubscribeKey = SubscribeKey("WEBVIEW_TEXTAREA_HEIGHT_CHANGE")
