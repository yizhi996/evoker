...
extension UIView {
    ...
    func fadeIn(duration: TimeInterval = 0.3, ease: UIView.AnimationOptions = .curveEaseInOut, completionHandler handler: NZEmptyBlock? = nil) {
    ...
    func fadeOut(duration: TimeInterval = 0.3, ease: UIView.AnimationOptions = .curveEaseInOut, completionHandler handler: NZEmptyBlock? = nil) {
        UIView.animate(withDuration: duration, delay: 0, options: ease) {
            self.alpha = 0.0
        } completion: { finished in
            handler?()
    ...
    func popup(duration: TimeInterval = 0.5, completionHandler handler: NZEmptyBlock? = nil) {
    ...
    func popdown(duration: TimeInterval = 0.3, completionHandler handler: NZEmptyBlock? = nil) {
