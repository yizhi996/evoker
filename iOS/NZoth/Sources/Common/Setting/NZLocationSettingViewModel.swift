//
//  NZLocationSettingViewModel.swift
//
...
class NZLocationSettingViewModel {
    ...
    init(current: String) {
        ...
        sectionInfo = NZStaticTableViewSectionInfo(header: "你的位置信息将用于小程序位置接口的效果展示")
...
extension NZLocationSettingViewModel {
    
    func generateViewController() -> UIViewController {
        return NZLocationSettingViewController(viewModel: self)
    }
}
